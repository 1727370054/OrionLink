...
enum GetServiceReq_Type : int {
  ...
  GetServiceReq_Type_GetServiceReq_Type_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  GetServiceReq_Type_GetServiceReq_Type_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
inline bool GetServiceReq_Type_Parse(
    const std::string& name, GetServiceReq_Type* value) {
...
inline ::msg::GetServiceReq_Type GetServiceReq::type() const {
  ...
  return static_cast< ::msg::GetServiceReq_Type >(type_);
}
