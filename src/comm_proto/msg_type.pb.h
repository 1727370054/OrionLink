...
enum MsgType : int {
  ...
  MSG_ADD_LOG_REQ = 211,
  MSG_GET_AUTH_CODE = 212,
  MSG_REGISTER_USER_REQ = 213,
  MSG_REGISTER_USER_RES = 214,
  MSG_EMAIL_LOGIN_REQ = 215,
  MSG_EMAIL_LOGIN_RES = 216,
  MSG_FORGET_PASSWORD_REQ = 217,
  MSG_FORGET_PASSWORD_RES = 218,
